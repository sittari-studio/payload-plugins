...
export type SerializedLinkFieldNode<TChild extends SerializedLexicalNode = SerializedLexicalNode> =
...
export type ResolveUrlHookArgs = FieldHookArgs<any, null | string, LinkFieldValue>;

export const LINK_FIELD_MARKER = "@sittari/payload-link-field";

export const LINK_FIELD_ADMIN_COMPONENT = "@sittari/payload-link-field/client#LinkField";
