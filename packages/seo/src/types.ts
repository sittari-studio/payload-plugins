...
export const SEO_SETTINGS_SCHEMA_MANAGER_ADMIN_COMPONENT =
  '@sittari/payload-seo/client#SettingsSchemaManager';
export const SEO_DOCUMENT_SCHEMA_MANAGER_ADMIN_COMPONENT =
...
export type SeoPayload = {
  ...
  ) => Promise<{ docs: SeoDocument[]; totalDocs?: number }>;
  config?: {
...
export type ResolvedSitemapSeo = Pick<
