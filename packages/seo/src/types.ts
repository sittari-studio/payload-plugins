...
import type { JsonObject, SeoCollectionSchemaTemplates, SeoDocumentSchema, SeoGlobalSchemaOverride, SeoJsonPatchOperation, SeoSchemaInstance, SeoSchemaTemplate, SeoSchemaVariable } from './schema/types.js'
