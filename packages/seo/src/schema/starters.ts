...
export const SEO_SCHEMA_STARTERS = {
  WebPage: { '@type': 'WebPage', name: '$title', description: '$description', url: '$canonicalUrl' },
  Article: { '@type': 'Article', headline: '$title', description: '$description', url: '$canonicalUrl' },
  Product: { '@type': 'Product', name: '$title', description: '$description', url: '$canonicalUrl' },
