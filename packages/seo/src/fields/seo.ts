            ...
            fields: [
              {
                name: 'title',
                type: 'text',
                label: adminLabel('title'),
                localized,
              },
              {
                name: 'description',
                type: 'textarea',
                label: adminLabel('description'),
                localized,
              },
              {
                name: 'focusKeyword',
                type: 'text',
                label: adminLabel('focusKeyword'),
                localized,
            ...
            fields: [
              {
                name: 'canonical',
                type: 'group',
                label: adminLabel('canonical'),
                fields: [
                  {
                    name: 'mode',
                    type: 'select',
                    label: adminLabel('canonicalMode'),
                    localized,
                    defaultValue: 'auto',
                    required: true,
                    options: [
                      { label: adminLabel('auto'), value: 'auto' },
                      { label: adminLabel('manual'), value: 'manual' },
                ...
                fields: [
                  {
                    ...
                    required: true,
                    options: [
                      { label: adminLabel('inherit'), value: 'inherit' },
                      {
                        label: adminLabel('indexFollow'),
                        value: 'index-follow',
                      },
                      {
                      ...
                      {
                        label: adminLabel('customDirectives'),
                        value: 'custom',
                      },
                    ],
                  },
            ...
            fields: [
              {
                ...
                type: 'array',
                label: adminLabel('documentSchemas'),
                admin: { hidden: true },
                fields: [
                  {
                    name: 'schemaId',
              ...
              {
                name: 'globalSchemaOverrides',
                type: 'array',
                label: adminLabel('schemaOverrides'),
                admin: { hidden: true },
                fields: [
                  {
                    name: 'schemaId',
              ...
              },
              {
                ...
                admin: {
                  components: {
                    Field: SEO_DOCUMENT_SCHEMA_MANAGER_ADMIN_COMPONENT,
                  },
                  custom: {
                    seo: {
                      mode: 'document',
                      ...
                      collectionVariables: {
                        [collectionSlug]: schemaVariables,
                      },
                    },
                  },
                },
