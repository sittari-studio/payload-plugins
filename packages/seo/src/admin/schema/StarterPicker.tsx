...
export const StarterPicker = ({
  ...
  return (
    <div>
      <div className="st-flex st-items-center st-justify-between st-gap-base max-[600px]:st-flex-col max-[600px]:st-items-stretch [&_h3]:st-m-0 [&_p]:st-mb-0 [&_p]:st-mt-[.35rem] [&_p]:st-text-elevation-600">
        <div>
