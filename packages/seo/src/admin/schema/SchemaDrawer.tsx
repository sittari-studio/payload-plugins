...
export const SchemaDrawer = ({
  ...
  return (
    <Drawer
      className="seo-schema-drawer [&_.checkbox-input]:st-mb-0 [&_.field-type]:st-mb-0 [&_h3]:st-m-0 [&_h4]:st-m-0 [&_p]:st-mb-0 [&_p]:st-mt-[.35rem] [&_p]:st-text-elevation-600"
      slug={slug}
      title={title}
    >
      <DrawerContentContainer className="st-flex st-min-h-0 st-w-full st-flex-1 st-flex-col st-overflow-hidden st-p-0">
        <div className="st-min-h-0 st-flex-1 st-overflow-auto st-py-base-125 max-[600px]:st-p-base">
          {children}
        </div>
