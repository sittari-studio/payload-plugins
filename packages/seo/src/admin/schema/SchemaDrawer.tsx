...
export const SchemaDrawer = ({ children, onCancel, onSave, saveDisabled, saveLabel, slug, title }: {
  ...
  return <Drawer className="seo-schema-drawer [&_.field-type]:st-mb-0 [&_.checkbox-input]:st-mb-0 [&_h3]:st-m-0 [&_h4]:st-m-0 [&_p]:st-mt-[.35rem] [&_p]:st-mb-0 [&_p]:st-text-elevation-600" slug={slug} title={title}>
