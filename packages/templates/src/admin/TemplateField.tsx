...
import { GroupField, useConfig, useLocale, useTranslation } from '@payloadcms/ui'
...
export const TemplateField = (props: GroupFieldClientProps) => {
  ...
  const custom = props.field.admin?.custom as TemplateFieldAdminCustom | undefined
    ...
    <div className="template-field">
      {templateURL && (
        <div style={{ fontSize: '13px', marginBottom: '6px', textAlign: 'right' }}>
          <a href={templateURL}>
            {translate('editTemplate', i18n.language)}
          </a>
        </div>
      )}
