...
export const TEMPLATE_FIELD_MARKER = '@sittari/payload-templates/template-field'
...
export const getTemplateFieldName = (field: Field): string | undefined => {
  ...
  const templateField = (field.custom as TemplateFieldCustom | undefined)?.templateField
