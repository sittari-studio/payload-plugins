...
- Fork `@whatworks/payload-rbac` 0.4.0 at upstream commit
  `f7556471744fd5b01903cc2e452a0e22f41e618c`.
- Add typed English, Ukrainian, and Russian localization for generated collection
  labels, field labels and descriptions, permission options, and the permissions
  matrix UI.
- Adapt package exports and build scripts to the Sittari plugin monorepo.

The entries below are the retained upstream changelog.
